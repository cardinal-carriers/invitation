/* ==========================================================================
   ...
   Mount one with:
       ...
       Envelope.mount('#sc', { to:{…}, card:{…}, die:'m-pram' }).onOpen(fn)

   Markup is generated, not hand-written, because the same envelope appears
   on the guest invite, the invitation editor and the send preview. In
   Next.js this file becomes <Envelope guest={…} event={…} />.
   ========================================================================== */
...
const DEFAULTS = {
  ...
  to:   { name:'Eleanor Vance', l1:'88 Rideau Street', l2:'Ottawa, ON&nbsp; K1N 5W8' },
    ...
    <div class="flip">
      ...
      <div class="face front">
        ...
        <div class="to"><hr class="hr">
          ...
          <div class="ln" data-f="to.l1">${o.to.l1}</div>
          <div class="ln" data-f="to.l2">${o.to.l2}</div>
        </div>
      </div>
...
class EnvelopeInstance {
  ...
  /** Live-update one field, e.g. set('to.name', 'Eleanor Vance'). */
  set(path, value){
